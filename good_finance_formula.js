...
good_xrp_finance_formular({
  ...
  current_date: Date.now() < 1717520400000 ? new Date('06/05/2024') : new Date(Date.now()),
  your_age_that_you_suppose_to_run_out_of_xrp: 60,
  your_current_xrp_amount: 54110,
  current_xrp_usd_price: 0.49,
  current_usd_vnd_price: 23500,
  vnd_amount_you_want_to_get_monthy: 1000000 * 20,
  vnd_amount_that_you_used_to_buy_xrp: 1000000 * 785,
